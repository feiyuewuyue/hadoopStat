...
public class RankSettingReader {
private static final Logger LOG = Logger.getLogger(RankSettingReader.class);
	
	private static final String CONFIG_FILE = "rankSetting.yaml";
	...
	private static void loadYaml(String confPath) {
		...
		try {
			stream = RankSettingReader.class.getClassLoader().getResourceAsStream(confPath);
