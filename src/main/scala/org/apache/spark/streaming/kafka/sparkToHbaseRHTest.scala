 ...
 *
 */
object sparkToHbaseRHTest extends Serializable {
  @transient lazy val log = LogManager.getRootLogger
  def functionToCreateContext(args: Array[String]): StreamingContext = {
    val sparkConf = new SparkConf().setAppName("sparkToHbaseRHTest")
 ...
 val hbaseTablePrefix = args(0)
    ...
    hConf.set("hbase.zookeeper.quorum", "183.131.54.183:2181,183.131.54.182:2181,183.131.54.181:2181");
    ...
    val kafkaParams = scala.collection.immutable.Map[String, String]("metadata.broker.list" -> "183.131.54.182:2181,183.131.54.183:9092,183.131.54.181:9092,183.131.54.178:9092", "auto.offset.reset" -> "largest", "group.id" -> args(4),"auto.commit.enable"->"false")
